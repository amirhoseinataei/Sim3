function Mymethod(){
    ...
    for (i = 1; i <= 20; i++)
    {
        ...
        // **************************** Table ************************
        var header_table = "<caption>شبیه سازی برای خرید 70 روزنامه</caption><tr><th>سود روزانه</th><th>درآمد ناشی از فروش به قیمت باطله</th><th>سود از دست رفته به خاطر فزونی تقاضا</th><th>درآمد حاصل از فروش</th><th>تقاضا</th><th>ارقام تصادفی برا تقاضا</th><th>نوع روز</th><th>ارقام تصادفی برای تعیین نوع روز</th><th>روز</th></tr>";
        var row_col_table;
        var footer_table;
        row_col_table = "<tr><td>" 
        + benefit[i] + "</td><td>" 
    ...
    all_table=  body_table + footer_table;
